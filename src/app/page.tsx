    ...
    <div className="grid grid-rows-2 text-gray-400 md:grid-cols-2 md:grid-rows-1 items-center justify-items-center h-screen bg-gradient-to-r from-stone-900 to-gray-900 p-0 m-0 pb-0 gap-2 sm:p-5  font-[family-name:var(--font-geist-sans)]">
      ...
      <div className=" grid  items-center justify-center h-full w-full overflow-y-scroll ">
        <section id="about" className="p-5   rounded-lg ">
          ...
          <p className="text-base">Beyond technical skills, I bring strong <strong className="font-extrabold text-slate-400"> problem-solving abilities, attention to detail, and clear communication </strong> to every project. I’m dedicated to continuous learning and delivering high-quality work that helps businesses grow online. My goal is to combine creativity and technology to build impactful digital experiences.</p>
        </section>
